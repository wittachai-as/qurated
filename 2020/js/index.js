...
function pageTransition() {
    ...
    tl.fromTo(menu, 0, { opacity: 1, y: 0 }, { opacity: 0, y: -100 });
    tl.set('body', { overflow: 'auto' });
    menu.classList.remove("active");

    var port_menu = document.querySelector(".portfolio_menu");
    tl.fromTo(port_menu, 0, { opacity: 1, y: 0 }, { opacity: 0, y: -100 });
...
*/
    ...
    if(portfolio_close) {
        $('.portfolio_close').on('click', function() {
            TweenMax.fromTo(port_menu, 0.5, { opacity: 1, y: 0 }, { opacity: 0, y: -100 });
    ...
    if(btn_port_menu) {
        $('.btn_port_menu').on('click', function() {
            ...
            TweenMax.fromTo(port_menu, 0.5, { opacity: 0, y: -100 }, { opacity: 1, y: 0 });
...
close.addEventListener("click", function() {
    TweenMax.fromTo(menu, 0.5, { opacity: 1, y: 0 }, { opacity: 0, y: -100 });
...
btn_menu.addEventListener("click", function() {
    TweenMax.set('body', { overflow: 'hidden' });
    TweenMax.fromTo(menu, 0.5, { opacity: 0, y: -100 }, { opacity: 1, y: 0 });
    TweenMax.to('.close', 0.5, {autoAlpha:1});
    menu.classList.add("active");
});

var prevButton = document.querySelector("#prevButton");
var nextButton = document.querySelector("#nextButton");
var boxes = document.querySelectorAll(".q_fashion_mark_list");
...
function videoActive(){
    $(".link").click(function(event) {
        ...
        TweenMax.to(".player", {autoAlpha:1, onComplete:play_yt});
        TweenMax.to(".close_video", 0.3, {autoAlpha:1, delay:0.5});
    });
    $(".close_video").click(function(event) {
        TweenMax.to("#overlay", 0.5, {autoAlpha:0});
        TweenMax.to(".player", {autoAlpha:0, onComplete:stop_yt});
        TweenMax.to(".close_video", 0.5, {autoAlpha:0});
    });

    $(".btn_search").click(function(event) {
        TweenMax.to("#search", 0.5, {autoAlpha:1});
        TweenMax.to(".search_close", 0.3, {autoAlpha:1, delay:0.5});
    });
    $(".search_close").click(function(event) {
        TweenMax.to("#search", 0.5, {autoAlpha:0});
        TweenMax.to(".search_close", 0.5, {autoAlpha:0});
    });
    }